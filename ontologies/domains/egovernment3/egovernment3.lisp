...
(in-ontology egovernment3)


;;;now thing is the toplevel class
;;;john d 6/12/04
;;(def-class e-gov-top ())

(def-class thing ()) ;;john d 6/12/04(E-GOV-TOP))

(def-class tangible-thing (thing))

(def-class intangible-thing (thing))

(def-class marital-status (intangible-thing) ;;;john d 3/12/04 (E-GOV-TOP)
  )

(def-class time-point (intangible-thing) ;;john d 3/12/04 (E-GOV-TOP)
...
(def-class CLIENT (thing) ;;john d 3/12/04 (E-GOV-TOP)
...
(def-class ENTITLEMENT (thing) ;;john d 3/12/04 (E-GOV-TOP )
...
(def-class ENTITLEMENT-TYPE (thing) ;;john d 3/12/04 (E-GOV-TOP )
 ((has-eligibility-criteria :type eligibility-criteria)
))

(def-class ELIGIBILITY-CRITERIA (intangible-thing) ;;john 3/12/04 (E-GOV-TOP )
...
(def-class couple (intangible-thing) ;;3/12/04 john d(e-gov-top)
 ((has-citizen1 :type citizen)
  (has-citizen2 :type citizen)))

(def-class asset (thing) ;;john d 3/12/4 (e-gov-top)
...
(def-class CURRENCY (intangible-thing) ;;john d 3/12/04 (thing) ;;(information-bearing-object)
   ((issued-by :type government)))

(def-class AMOUNT-OF-MONEY (intangible-thing) ;;john d 3/12/04 (thing) ;; (Physical-Quantity)
...
(def-class AGENCY (ORGANIZATION-UNIT )) ;;E-GOV-TOP john d 6/12/04
