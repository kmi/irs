...
(def-class ENTITLEMENT-TYPE (E-GOV-TOP )
...
(def-class CASE (E-GOV-TOP)
 ((has-status :type string )
  ...
  (has-assessment :type  assessmen :cardinality 1)
  (has-decision :type decision :cardinality 1)
 ))

(def-class ASSESSMENT (E-GOV-TOP)
...
(def-class couple (e-gov-top)
 ((has-citizen1 :type citizen)
  (has-citizen2 :type citizen)))

(def-class asset (e-gov-top)
...
(def-class citizen (person CLIENT )
 ((full-name :type string)
  (family-name :type string)
  (given-name :type string)
  (has-gender :type gender)
  (has-address :type address)
  (has-marital-status :type string)
  (has-religion :type string)
  (has-ethnicity :type string)
  (has-type-of-accomodation :type string)
  (has-date-of-birth :type string)
...
(def-instance daughter-attendance-service SERVICE
 ((has-entitlement-type attendance-allowance)
  (has-entitlement-provider jobCentre-plus)
...
(def-instance daughter-carer-service SERVICE
 ((has-entitlement-type carers-allowance)
  (has-entitlement-provider disability-and-carers)
