...
(in-ontology ecai-papers-ontology)

(def-class ai-class)

(def-class automated-reasoning-area (ai-class)
 (
...
(def-class nonmonotonic-reasoning-area (ai-class)
 (
...
(def-class knowledge-representation-area (ai-class)
 (
...
(def-class cognitive-modelling-area (ai-class)
 (
...
(def-class constraint-based-reasoning-area (ai-class)
 (
...
(def-class distributed-ai-area (ai-class)
 (
...
(def-class human-language-technology-area (ai-class)
 (
...
(def-class machine-learning-area (ai-class)
 (
...
(def-class knowledge-based-systems-area (ai-class)
 (
...
(def-class planning-area (ai-class)
 (
    (planning :value yes)
...
(def-class qualitative-reasoning-area (ai-class)
 (
...
(def-class robotics-area (ai-class)
 (
    (robotics :value yes)
...
(def-class search-area (ai-class)
 (
    (search :value yes)
...
(def-class uncertainty-in-ai-area (ai-class)
 (
...
(def-class intelligent-user-interfaces-area (ai-class)
 (
...
(def-class prestigous-applications-of-intelligent-systems-pais-area (ai-class)
 (
