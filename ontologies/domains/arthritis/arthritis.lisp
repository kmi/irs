...
(def-class medical-condition () 
  ((has-technical-name :type string)
   ...
   (susceptible-groups :type population-specification)  
   (caused-by :type medical-condition-causing-agent) ;; virus/bacterium etc.
   (reported-symptoms :type medical-symptom)
   (has-site :type site)
   (onset :type onset-index) ;;e.g. gradual
   (has-periodicity :type periodicity-index)
   (has-severity :type severity-index)
   (has-rarity :type rarity-index) ;;rare-common
   (physical-examination-result :type examination-result)
   (test-result :type test-result)
   (can-be-treated-by  :type treatment)
   (sequelae :type medical-condition)
   (sequela-of :type medical-condition)
   (associated-with :type medical-condition)
   (part-of-syndrome :type syndrome)
   (possible-confusibles :type medical-condition)
   (discriminators :type medical-symptom)
   (prognosis :value prognosis)
   )
  )

(def-domain-class disorder (medical-condition) 
  ((caused-by :type disorder-causing-agent) ;; injury/wear-and-tear etc.
   )
  )

(def-domain-class disease (medical-condition) 
...
(def-domain-class autoimmune-disorder (disorder) 
  )
...
(def-domain-class osteoarthritis (arthritis) 
  ((disease-alternative-name :value degenerative-arthritis
   ...
   (can-be-treated-by :default-value (analgesic-drugs pain) 
              :default-value (nonsteroidal-anti-inflammatories  inflammation) 
              :default-value (corticosteroid  painful-joint)
              :default-value (physiotherapy  general-symptoms)
              )
...
(def-domain-class severe-osteoarthritis (osteoarthritis) 
  ((reported-symptoms :value severe-joint-pain 
   ...
   (can-be-treated-by :value (arthroplasty relieve-symptoms) ;; joint replacement *********
...
(def-domain-class rheumatoid-arthritis (arthritis autoimmune-disorder) 
  ((disease-alternative-name :value none)
   ...
   (site :value fingers
         ...
         :value joints)
   (onset gradual) ;;???
   (has-periodcity recurrent-attacks)
   (severity moderate)
   ...
   (can-be-treated-by :value (antirheumatic-drugs slow-progress) 
...
(def-domain-class severe-rheumatoid-arthritis (arthritis) 
  ((disease-name :value severe-rheumatoid-arthritis)
   ...
   (site :value hip
         :value knee)
   (has-periodcity frequent-attacks)
   (severity severe)
   (test-result :value (x-ray severe-joint-deformities positive)
                )   
   (can-be-treated-by :value (arthroplasty relieve-symptoms) ;; **************
              )
   )
  )
...
(def-domain-class ankylosing-spondylitis (arthritis) 
  ((disease-alternative-name :value none)
   ...
   (can-be-treated-by :value (heat relieve-general-symptoms) 
...
(def-domain-class gout (arthritis) 
  ((disease-alternative-name :value none)
   ...
   (can-be-treated-by :value (nonsteroidal-anti-inflammatories relieve-joint-pain-inflammation)
...
(def-domain-class lupus (skin-disease joint-disorder autoimmune-disorder) 
 "causes inflammation of connective tissue - CHEP p. 650"
 (
  ...
  (has-periodicity :value symptoms-subside-and-recur)
  ...
  (can-be-treated-by :value (anti-malarial-drugs skin-rash) 
             :value (nonsteroidal-anti-inflammatories relieve-joint-pain-stiffness) 
...
(def-domain-class systemic-lupus-erythematosus (lupus) 
  ((disease-alternative-name :value SLE)
   ...
   (can-be-treated-by :value (nonsteroidal-anti-inflammatories relieve-joint-pain-stiffness) 
              :value (corticosteroid  relieve-fever)
              :value (corticosteroid  relieve-pleurisy)
              :value (corticosteroid  relieve-neurological-symptoms)
              :value (immuno-suppressant-drugs relieve-severe-neurological-symptoms)
...
(def-domain-class influenza (upper-respiratory-tract-disease) 
  ((disease-short-name :value flu)
   ...
   (can-be-treated-by :value (salicylates discomfort) 
...
(def-domain-class pneumococcal-pneumonia (bacterial-pneumonia) 
  ((disease-alternative-name :value acute-lobar-pneumonia)
   ...
   (can-be-treated-by :value (benzyl-penicillin 600);; mg
...
(def-domain-class arthroplasty (body-part-replacement)
  "replacement joint/part by metal or plastic components"
  (
   (site 
         :value hip 
         :value knees 
...
(def-relation query3 (?x ?c)
  :sufficient (and 
               (can-be-treated-by ?x (arthroplasty ?rest))
             (disease-name ?x ?c)))
