...
(def-class packaged-shopping-item (shopping-item)
  ((pack-size :type string)
...
(def-class customer-profile (information-stuff)
  ((number-of-visits :type integer :cardinality 1)
   ...
   (type-of-goods-most-frequently-bought :type list)
   (list-of-goods-browsed :type shopping-item :default-value nil)
   (list-of-goods-bought :type shopping-item :default-value nil)))
